...
import time
import random
RUNTIME_DICT = {'vole':000, 'day':1, 'experiment':'contingent_2_lever_reward_both', 'lever_1_active':1, 'lever_2_active':1}
            ...
            while lever_phase.active():
                ...
                if lever_1.presses_reached:
                    ...
                    if RUNTIME_DICT['lever_1_active'] == 1:
                        ...
                        dispenser_1.dispense(wait = True)
                    ...
                    if RUNTIME_DICT['lever_2_active'] == 1:
                        ...
                        dispenser_2.dispense(wait = True)
                        pellets_dispenser_2_remaining -= 1
