...
setuptools.setup(
    ...
    install_requires = ['pandas','numpy', 'pyyaml','RPi-GPIO','gpiozero','lgpio','himl', 'pyserial', 'adafruit-circuitpython-servokit','himl','adafruit-circuitpython-mcp230xx','install PyTmcStepper']
